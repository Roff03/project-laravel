...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-xl  p-6 w-full max-w-md">
        <h2 class="text-2xl font-bold text-center mb-4">Sukamulya Aplikasi<br class="font-semibold"></h2>
        <hr class="my-4">
        @if(session('error'))
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <hr class="my-4">
            <p class="text-center text-sm text-gray-600">Belum punya akun? <a href="{{route('register')}}" class="text-purple-600 hover:text-purple-800">Register</a> sekarang!</p>
        </form>
    </div>
</body>
</html>
